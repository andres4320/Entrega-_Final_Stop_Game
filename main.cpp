...
//Mostrar las palabras que ingreso el jugador dentro de la tabla
  ...
  cout <<"\n----------------------------------------------------------TOTALES------------------------------------------------------------------------------------\n\n";
cout<<"El puntaje final es: "<<puntajeFinal<<"\n";  
cout<<"El tiempo final es "<<tiempoFinal;
}
